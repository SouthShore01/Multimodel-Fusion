...
class WHUTMSFVesselAdapter(BaseDatasetAdapter):
    ...
    def load_metadata(self):
        ...
        self.radar_files = list(root.rglob("*radar*"))
        self.visible_files = list(root.rglob("*visible*")) + list(root.rglob("*.jpg"))
        self.ais_files = list(root.rglob("*ais*.csv"))
        raise RuntimeError("WHUT-MSFVessel adapter is a template. Please map dataset-specific files to the common Detection schema.")
